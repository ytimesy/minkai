...
robot.update!(
  ...
  success_metric: <<~TEXT.strip,
    ...
    REQ-005 30分以上の連続動作を目指す
    REQ-006 部品表と組み立て手順を公開できる
  TEXT
  status: "設計中",
  ...
  development_log: <<~TEXT.strip,
    ...
    2026-05-14 [試験項目] TEST-001からTEST-005を追加
  TEXT
...
[
  ...
  ["30分連続動作テスト", "REQ-005", "低速巡回を30分継続する", "異常停止や過熱がない", "未実施"]
...
[
  ["モーター候補を比較する", "REQ-005 / 部品表: 左右モーター / 関連試験: TEST-005", "募集中", "担当者募集中", "必要トルク、価格、入手性、制御しやすさを比較する。"],
  ["非常停止ボタン位置をレビューする", "REQ-004 / 安全設計: 非常停止 / 関連試験: TEST-004", "募集中", "レビュー待ち", "上面中央に配置する案の押しやすさと配線を確認する。"],
  ["障害物停止テスト手順を作成する", "REQ-003 / 部品表: 距離センサー / 関連試験: TEST-003", "募集中", "未着手", "停止距離、速度、センサー位置の記録方法を決める。"],
  ["Python制御とROS 2構成を比較する", "REQ-001 / ソフトウェア設計 / 関連試験: TEST-001", "募集中", "未着手", "初期MVPに適した制御構成を比較表にする。"]
